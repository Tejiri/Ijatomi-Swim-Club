            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="100m">
                        <form action="{{ url('/update-coach-squad/' . $user->id) }}" method="POST" class="col-md-8" style="margin-top: 20px;" >
                            {{-- <hr style="background-color: black; color: black; height: 1px;"> --}}
                            @csrf
                            {{-- <h3>Update Squad</h3> --}}
                            <h4 style="margin:0px; padding: 0px;font-weight: bold; color: black; margin-bottom: 10px;">Current Squad:
                                @if ($squad != null)
                                    {{ $squad->name }}
                                @else
                                    None assigned yet
