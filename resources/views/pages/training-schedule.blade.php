                        ...
                        @foreach ($squads as $squad)
                            <tr>
                                ...
                                @if (count($squad->trainingSessions->where('day', 'Tuesday')))
                                    <td>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ url('/update-training-session/' . $squad->trainingSessions->where('day', 'Tuesday')->first()->id) }}"
                                                style="color: black; text-decoration: none;">
                                ...
                                @if (count($squad->trainingSessions->where('day', 'Wednesday')))
                                    <td>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ url('/update-training-session/' . $squad->trainingSessions->where('day', 'Wednesday')->first()->id) }}"
                                                style="color: black; text-decoration: none;">
                                ...
                                @if (count($squad->trainingSessions->where('day', 'Thursday')))
                                    <td>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ url('/update-training-session/' . $squad->trainingSessions->where('day', 'Thursday')->first()->id) }}"
                                                style="color: black; text-decoration: none;">
                                ...
                                @if (count($squad->trainingSessions->where('day', 'Friday')))
                                    <td>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ url('/update-training-session/' . $squad->trainingSessions->where('day', 'Friday')->first()->id) }}"
                                                style="color: black; text-decoration: none;">
                                ...
                                @if (count($squad->trainingSessions->where('day', 'Saturday')))
                                    <td>
                                        @if (Auth::user()->role == 'admin')
                                            <a href="{{ url('/update-training-session/' . $squad->trainingSessions->where('day', 'Saturday')->first()->id) }}"
                                                style="color: black; text-decoration: none;">
